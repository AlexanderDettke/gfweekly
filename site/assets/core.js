...
function gfMountTopbar(active){
  ...
  el.innerHTML=`
    ...
    <nav class="nav" aria-label="Hauptnavigation">
      ...
      <a href="cockpit.html" data-k="cockpit"><span class="lbl">Cockpit</span></a>
      ...
      <a href="inbox.html" data-k="inbox"><span class="lbl">Inbox</span><span class="nbadge" id="inboxBadge" style="display:none">0</span></a>
  ...
  gfApi("inbox_list",{statuses:["neu"]}).then(d=>{ const n=(d.items||[]).length; const b=el.querySelector("#inboxBadge"); if(n>0){ b.textContent=n; b.style.display="inline-flex"; } }).catch(()=>{});
}
