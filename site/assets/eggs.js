...
(function(){
  ...
  const BUS = `<svg viewBox="0 0 220 110" width="220" height="110" aria-hidden="true"><path d="M14 30h150l30 26v26H14z" fill="var(--accent)"/><path d="M14 52h180v12H14z" fill="var(--on-photo)"/><rect x="24" y="36" width="30" height="20" fill="var(--surface)"/><rect x="62" y="36" width="30" height="20" fill="var(--surface)"/><rect x="100" y="36" width="30" height="20" fill="var(--surface)"/><path d="M164 36l22 20h-22z" fill="var(--surface)"/><rect x="30" y="18" width="110" height="12" fill="#c98a4b"/><rect x="40" y="10" width="26" height="8" fill="#e0722d"/><rect x="80" y="10" width="40" height="8" fill="#5c9a3a"/><circle cx="52" cy="84" r="14" fill="#1f1f22"/><circle cx="52" cy="84" r="6" fill="#bdbdbd"/><circle cx="160" cy="84" r="14" fill="#1f1f22"/><circle cx="160" cy="84" r="6" fill="#bdbdbd"/><rect x="190" y="60" width="6" height="8" fill="#f2c14e"/></svg>`;
