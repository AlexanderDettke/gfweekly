#!/bin/zsh
# Abnahme des Hohen Hauses: Tokens, Farben, Kontrast, Schirme. Bricht beim ersten Fehler ab.
# Aufruf aus dem Repo:  PLAYWRIGHT_MODUL=<pfad>/node_modules/playwright/index.mjs ./pruefung/abnahme.sh [zielordner]
set -e
set -o pipefail
cd "$(dirname "$0")/.."
...
echo "\n== Schirme (13 Seiten, 1440 und 390, dunkel und hell) =="
